...
void user_kinematics_model(MbsData *mbs_data, double **PxF_tab, double ***RxF_tab, double **VxF_tab, double **OMxF_tab)
{
    ...
    double PxF1[4], PxF2[4], PxF3[4], PxF4[4], PxF5[4], PxF6[4], PxF7[4], PxF8[4], PxF9[4], PxF10[4], PxF11[4], PxF12[4], PxF13[4];
    double RxF1[4][4], RxF2[4][4], RxF3[4][4], RxF4[4][4], RxF5[4][4], RxF6[4][4], RxF7[4][4], RxF8[4][4], RxF9[4][4], RxF10[4][4], RxF11[4][4], RxF12[4][4], RxF13[4][4];
    double VxF1[4], VxF2[4], VxF3[4], VxF4[4], VxF5[4], VxF6[4], VxF7[4], VxF8[4], VxF9[4], VxF10[4], VxF11[4], VxF12[4], VxF13[4];
    double OMxF1[4], OMxF2[4], OMxF3[4], OMxF4[4], OMxF5[4], OMxF6[4], OMxF7[4], OMxF8[4], OMxF9[4], OMxF10[4], OMxF11[4], OMxF12[4], OMxF13[4];

    double C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C33, C34, C35;
    double S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S20, S21, S22, S23, S24, S25, S26, S27, S28, S29, S33, S34, S35;
    ...
    double ROcp37_234, ROcp37_334, ROcp37_834, ROcp37_934, ROcp37_135, ROcp37_235, ROcp37_335, ROcp37_435, ROcp37_535, ROcp37_635, OMcp37_25, OMcp37_35, OMcp37_16, OMcp37_26, OMcp37_36;
    ...
    OMcp37_25 = qd[34]*C33;
    OMcp37_35 = qd[34]*S33;
    OMcp37_16 = qd[33]+qd[35]*S34;
    OMcp37_26 = OMcp37_25+qd[35]*ROcp37_834;
    OMcp37_36 = OMcp37_35+qd[35]*ROcp37_934;
    PxF13[1] = q[30];
    PxF13[2] = q[31];
    PxF13[3] = q[32];
    RxF13[1][1] = ROcp37_135;
    RxF13[1][2] = ROcp37_235;
    RxF13[1][3] = ROcp37_335;
    RxF13[2][1] = ROcp37_435;
    RxF13[2][2] = ROcp37_535;
    RxF13[2][3] = ROcp37_635;
    RxF13[3][1] = S34;
    RxF13[3][2] = ROcp37_834;
    RxF13[3][3] = ROcp37_934;
    VxF13[1] = qd[30];
    VxF13[2] = qd[31];
    VxF13[3] = qd[32];
    OMxF13[1] = OMcp37_16;
