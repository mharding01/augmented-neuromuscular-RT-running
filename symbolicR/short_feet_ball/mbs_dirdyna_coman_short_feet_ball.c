...
#include "mbs_dirdyna_coman_short_feet_ball.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
...
// Forward Kinematics 
  ...
  AlF333 = -s->g[3]*C33;
  OM134 = qd[33]*C34;
  OpF134 = -qd[33]*qd[34]*S34;
  AlF134 = -AlF333*S34;
  AlM134_31 = S33*S34;
  AlM134_32 = -C33*S34;
  OM135 = qd[34]*S35+OM134*C35;
  OM235 = qd[34]*C35-OM134*S35;
  OM335 = qd[35]+qd[33]*S34;
...
// Backward Dynamics 
  ...
  FA135 = -(s->frc[1][35]-s->m[35]*(AlF134*C35+AlF233*S35));
  FA235 = -(s->frc[2][35]+s->m[35]*(AlF134*S35-AlF233*C35));
  FA335 = -(s->frc[3][35]-s->m[35]*AlF333*C34);
  CF135 = -(s->trq[1][35]+s->In[1][35]*(qd[35]*OM134*S35-C35*(OpF134+qd[34]*qd[35]))+OM235*OM335*(s->In[5][35]-
 s->In[9][35]));
  CF235 = -(s->trq[2][35]+s->In[5][35]*(qd[35]*OM134*C35+S35*(OpF134+qd[34]*qd[35]))-OM135*OM335*(s->In[1][35]-
 s->In[9][35]));
  CF335 = -(s->trq[3][35]-qd[33]*qd[34]*s->In[9][35]*C34+OM135*OM235*(s->In[1][35]-s->In[5][35]));
  FB135_31 = s->m[35]*(AlM134_31*C35+C33*S35);
  FB235_31 = -s->m[35]*(AlM134_31*S35-C33*C35);
  FB135_32 = s->m[35]*(AlM134_32*C35+S33*S35);
  FB235_32 = -s->m[35]*(AlM134_32*S35-S33*C35);
  CM135_33 = s->In[1][35]*C34*C35;
  CM235_33 = -s->In[5][35]*C34*S35;
  CM335_33 = s->In[9][35]*S34;
  FF34_135 = FA135*C35-FA235*S35;
  FF34_235 = FA135*S35+FA235*C35;
  CF34_235 = CF135*S35+CF235*C35;
  FM3431_235 = FB135_31*S35+FB235_31*C35;
  CM3433_235 = CM135_33*S35+CM235_33*C35;
  CM3434_235 = s->In[1][35]*S35*S35+s->In[5][35]*C35*C35;
  FF33_134 = FA335*S34+FF34_135*C34;
  FF33_334 = FA335*C34-FF34_135*S34;
  CF33_134 = CF335*S34+C34*(CF135*C35-CF235*S35);
  FM3331_334 = -(s->m[35]*S33*C34*C34+S34*(FB135_31*C35-FB235_31*S35));
  CM3333_134 = CM335_33*S34+C34*(CM135_33*C35-CM235_33*S35);
  FF32_233 = -(FF33_334*S33-FF34_235*C33);
  FF32_333 = FF33_334*C33+FF34_235*S33;
  FM3231_233 = -(FM3331_334*S33-FM3431_235*C33);
  FM3231_333 = FM3331_334*C33+FM3431_235*S33;
  FM3232_333 = C33*(s->m[35]*C33*C34*C34-S34*(FB135_32*C35-FB235_32*S35))+S33*(FB135_32*S35+FB235_32*C35);
