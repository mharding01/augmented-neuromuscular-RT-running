...
#include "mbs_gensensor_coman_short_feet_ball.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
...
// Sensor Kinematics 
    ...
    ROcp33_834 = -S33*C34;
    ROcp33_934 = C33*C34;
    OMcp33_234 = qd[34]*C33;
    OMcp33_334 = qd[34]*S33;
    OPcp33_234 = qdd[34]*C33-qd[33]*qd[34]*S33;
    OPcp33_334 = qdd[34]*S33+qd[33]*qd[34]*C33;
...
// Sensor Kinematics 
    ...
    ROcp34_934 = C33*C34;
    ROcp34_135 = C34*C35;
    ROcp34_235 = ROcp34_234*C35+C33*S35;
    ROcp34_335 = ROcp34_334*C35+S33*S35;
    ROcp34_435 = -C34*S35;
    ROcp34_535 = -(ROcp34_234*S35-C33*C35);
    ROcp34_635 = -(ROcp34_334*S35-S33*C35);
    OMcp34_234 = qd[34]*C33;
    OMcp34_334 = qd[34]*S33;
    OMcp34_135 = qd[33]+qd[35]*S34;
    OMcp34_235 = OMcp34_234+ROcp34_834*qd[35];
    OMcp34_335 = OMcp34_334+ROcp34_934*qd[35];
    OPcp34_135 = qdd[33]+qdd[35]*S34+qd[34]*qd[35]*C34;
    OPcp34_235 = ROcp34_834*qdd[35]+qdd[34]*C33-qd[33]*qd[34]*S33+qd[35]*(OMcp34_334*S34-ROcp34_934*qd[33]);
    OPcp34_335 = ROcp34_934*qdd[35]+qdd[34]*S33+qd[33]*qd[34]*C33-qd[35]*(OMcp34_234*S34-ROcp34_834*qd[33]);
