...
//	==> Flops complexity : 8208
//
//	==> Generation Time :  0.280 seconds
...
#include "mbs_sensor_coman_init_feet.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
...
// Sensor Kinematics 
    ...
    RLcp6_136 = ROcp6_411*s->dpt[2][19]+s->dpt[1][19]*(ROcp6_110*C12-ROcp6_711*S12)+s->dpt[3][19]*(ROcp6_110*S12+ROcp6_711
 *C12);
    RLcp6_236 = ROcp6_511*s->dpt[2][19]+s->dpt[1][19]*(ROcp6_210*C12-ROcp6_811*S12)+s->dpt[3][19]*(ROcp6_210*S12+ROcp6_811
 *C12);
    RLcp6_336 = ROcp6_611*s->dpt[2][19]+s->dpt[1][19]*(ROcp6_310*C12-ROcp6_911*S12)+s->dpt[3][19]*(ROcp6_310*S12+ROcp6_911
 *C12);
...
// Sensor Kinematics 
    ...
    ROcp12_417 = ROcp12_415*C17+ROcp12_716*S17;
    ROcp12_517 = ROcp12_515*C17+ROcp12_816*S17;
    ROcp12_617 = ROcp12_615*C17+ROcp12_916*S17;
    ...
    OMcp12_118 = OMcp12_116+ROcp12_116*qd[17]+ROcp12_417*qd[18];
    OMcp12_218 = OMcp12_216+ROcp12_216*qd[17]+ROcp12_517*qd[18];
    OMcp12_318 = OMcp12_316+ROcp12_316*qd[17]+ROcp12_617*qd[18];
    RLcp12_142 = ROcp12_417*s->dpt[2][32]+s->dpt[1][32]*(ROcp12_116*C18-ROcp12_717*S18)+s->dpt[3][32]*(ROcp12_116*S18+
 ROcp12_717*C18);
    RLcp12_242 = ROcp12_517*s->dpt[2][32]+s->dpt[1][32]*(ROcp12_216*C18-ROcp12_817*S18)+s->dpt[3][32]*(ROcp12_216*S18+
 ROcp12_817*C18);
    RLcp12_342 = ROcp12_617*s->dpt[2][32]+s->dpt[1][32]*(ROcp12_316*C18-ROcp12_917*S18)+s->dpt[3][32]*(ROcp12_316*S18+
 ROcp12_917*C18);
