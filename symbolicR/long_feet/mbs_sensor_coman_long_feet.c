...
//
//	==> Generation Date : Thu Nov 26 12:46:02 2015
//
...
#include "mbs_sensor_coman_long_feet.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
...
// Sensor Kinematics 
    ...
    RLcp6_136 = s->dpt[1][19]*(ROcp6_110*C12-ROcp6_711*S12)+s->dpt[3][19]*(ROcp6_110*S12+ROcp6_711*C12);
    RLcp6_236 = s->dpt[1][19]*(ROcp6_210*C12-ROcp6_811*S12)+s->dpt[3][19]*(ROcp6_210*S12+ROcp6_811*C12);
    RLcp6_336 = s->dpt[1][19]*(ROcp6_310*C12-ROcp6_911*S12)+s->dpt[3][19]*(ROcp6_310*S12+ROcp6_911*C12);
