...
def make_var_plot(var, data_d, param_meta, regr_d, out_norm_flag = False):
...
if __name__ == "__main__":
    ...
    for param in range(nb_params):
        make_var_plot(param, data_d, param_meta, regr_d, out_norm_flag = False);
    for metric in metrics:
        make_var_plot(metric, data_d, param_meta, regr_d, out_norm_flag = False);
