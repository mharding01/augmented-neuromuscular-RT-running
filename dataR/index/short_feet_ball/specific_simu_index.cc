...
int ModelSimuIndex::get_mbs_joint_index(int joint_id)
{
	switch (joint_id)
	{
		...
		// ball A
		case SimuJointIndex::Ball_A_T1 : return FJ_T1_Ball_id;
		case SimuJointIndex::Ball_A_T2 : return FJ_T2_Ball_id;
		case SimuJointIndex::Ball_A_T3 : return FJ_T3_Ball_id;
		case SimuJointIndex::Ball_A_R1 : return FJ_R1_Ball_id;
		case SimuJointIndex::Ball_A_R2 : return FJ_R2_Ball_id;
		case SimuJointIndex::Ball_A_R3 : return FJ_R3_Ball_id;
...
int ModelSimuIndex::get_mbs_body_index(int body_id)
{
	switch (body_id)
	{
		...
		case SimuBodyIndex::Ball_A : return Ball_id;
...
int ModelSimuIndex::get_mbs_Ssens_index(int Ssens_id)
{
	switch (Ssens_id)
	{
		...
		// balls
		case SimuSsensIndex::Ball_A : return mbs_data->Nsensor + Ball_Force_id;
...
int ModelSimuIndex::get_mbs_Fsens_index(int Fsens_id)
{
	switch (Fsens_id)
	{
		...
		// balls
		case SimuFsensIndex::Ball_A : return Ball_Force_id;
