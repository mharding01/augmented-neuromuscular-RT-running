...
int ModelSimuIndex::get_mbs_joint_index(int joint_id)
{
	switch (joint_id)
	{
		...
		case SimuJointIndex::RightToePitch  : return RToe_id;
		...
		case SimuJointIndex::LeftToePitch  : return LToe_id;
...
int ModelSimuIndex::get_mbs_body_index(int body_id)
{
	switch (body_id)
	{
		...
		case SimuBodyIndex::RFootDistal : return RFoot_distal_id;
		...
		case SimuBodyIndex::LFootDistal : return LFoot_distal_id;
...
int ModelSimuIndex::get_mbs_Ssens_index(int Ssens_id)
{
	switch (Ssens_id)
	{
		...
		case SimuSsensIndex::RToe    : return mbs_data->Nsensor + RFoot_dist_force_id;
		case SimuSsensIndex::LToe    : return mbs_data->Nsensor + LFoot_dist_force_id;
...
int ModelSimuIndex::get_mbs_Fsens_index(int Fsens_id)
{
	switch (Fsens_id)
	{
		...
		case SimuFsensIndex::RightToe : return RFoot_dist_force_id;
		case SimuFsensIndex::LeftToe  : return LFoot_dist_force_id;
