 ...
 */
BTL_Muscle::BTL_Muscle(CtrlInputs *inputs, Articulation *roll_torso):
	Muscle(inputs, BTL_MUSCLE, TORSO_BODY, 0.043, 0.043, 250.0, 18.0, 0.11, 0.5) 
{
	rho_rt = 1.0;
	r0_rt  = 0.049;
 ...
 */
void BTL_Muscle::torques_compute()
{
