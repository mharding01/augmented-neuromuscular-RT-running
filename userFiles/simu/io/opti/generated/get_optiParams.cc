...
double convert_to_optiParams(std::vector<double> optiNorms)
{
	...
	switch (index)
	{
		...
		case 3 : return (last_elem * 4.03000000 + 0.97000000);
		case 4 : return (last_elem * 6.60000000 + 0.40000000);
		case 5 : return (last_elem * 20.00000000 + 0.00000000);
		case 6 : return (last_elem * 6.00000000 + 0.10000000);
		case 7 : return (last_elem * 9.00000000 + 1.00000000);
		case 8 : return (last_elem * 6.70000000 + 0.30000000);
