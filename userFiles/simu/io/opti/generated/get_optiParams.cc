...
double convert_to_optiParams(std::vector<double> optiNorms)
{
	...
	switch (index)
	{
		...
		case 9 : return (last_elem * 0.10000000 + 0.35000000);
		case 10 : return (last_elem * 2.00000000 + 12.00000000);
		case 11 : return (last_elem * 1.50000000 + 7.50000000);
		case 12 : return (last_elem * 1.50000000 + -3.50000000);
		case 13 : return (last_elem * 2.50000000 + 6.00000000);
		case 14 : return (last_elem * 1.50000000 + 6.00000000);
		case 15 : return (last_elem * 1.50000000 + 12.00000000);
		case 16 : return (last_elem * 2.00000000 + -7.00000000);
		case 17 : return (last_elem * 1.00000000 + 2.00000000);
		case 18 : return (last_elem * 1.50000000 + 5.00000000);
		...
		case 22 : return (last_elem * 2.00000000 + 11.00000000);
		case 23 : return (last_elem * 3.00000000 + 11.00000000);
		case 24 : return (last_elem * 6.00000000 + 25.00000000);
		case 25 : return (last_elem * 0.70000000 + 7.00000000);
		case 26 : return (last_elem * 1.30000000 + 0.20000000);
		case 27 : return (last_elem * 4.00000000 + 16.00000000);
		case 28 : return (last_elem * 0.30000000 + 5.20000000);
		case 29 : return (last_elem * 1.50000000 + 6.00000000);
		case 30 : return (last_elem * 2.00000000 + 0.00000000);
