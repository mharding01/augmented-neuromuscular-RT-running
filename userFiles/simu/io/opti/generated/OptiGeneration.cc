...
void OptiGeneration::set_opti()
{
	...
	stim_wang->set_theta_ref( optiParams[48] ); // TODO: trunk lean, realistic max i pi/12=15deg.
	...
	stim_wang->set_theta_h_ref0( optiParams[60] ); // TODO: made its lower bound smaller, come back to this later
