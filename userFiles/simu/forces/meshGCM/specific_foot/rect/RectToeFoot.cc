 ...
 */
RectToeFoot::RectToeFoot(MbsData *mbs_data, GaitFeatures *gait_features, SensorsInfo *sens_info, int foot_id): ContactFoot(mbs_data, gait_features, sens_info, foot_id, NB_POINTS)
{
	int index;
 ...
 */
Fsens_info* RectToeFoot::get_F_Sens_body()
{
	switch (foot_id)
	{
		case R_FOOT_ID:
