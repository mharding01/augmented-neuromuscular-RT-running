...
/*
 * Foot dimensions:
 * x: -0.06  to 0.045  = 0.105
 * y: -0.045 to 0.045 = 0.09
 */
#define NB_X_POINTS 4
 ...
 */
ShortShortFoot::ShortShortFoot(MbsData *mbs_data, GaitFeatures *gait_features, SensorsInfo *sens_info, int foot_id): ContactFoot(mbs_data, gait_features, sens_info, foot_id, NB_POINTS)
{
	int index;
 ...
 */
Fsens_info* ShortShortFoot::get_F_Sens_body()
{
	switch (foot_id)
	{
		case R_FOOT_ID:
