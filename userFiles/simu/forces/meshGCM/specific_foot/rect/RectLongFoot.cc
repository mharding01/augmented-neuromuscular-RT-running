...
#define NB_X_POINTS 20
#define NB_Y_POINTS 10
 ...
 */
RectLongFoot::RectLongFoot(MbsData *mbs_data, GaitFeatures *gait_features, SensorsInfo *sens_info, int foot_id): ContactFoot(mbs_data, gait_features, sens_info, foot_id, NB_POINTS)
{
	int index;
 ...
 */
Fsens_info* RectLongFoot::get_F_Sens_body()
{
	switch (foot_id)
	{
		case R_FOOT_ID:
