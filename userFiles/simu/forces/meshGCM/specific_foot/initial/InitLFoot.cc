 ...
 */
InitLFoot::InitLFoot(MbsData *mbs_data, GaitFeatures *gait_features, SensorsInfo *sens_info, int foot_id): ContactFoot(mbs_data, gait_features, sens_info, foot_id, NB_POINTS)
{
	// x axis
	rn[0][0]    = 0.087379;
	rn[1][0]    = 0.082;
 ...
 */
Fsens_info* InitLFoot::get_F_Sens_body()
{
	switch (foot_id)
	{
		case R_FOOT_ID:
