...
// IDs for the buffers
enum{BUFFER_Q, BUFFER_QD, BUFFER_QDD, BUFFER_QQ, BUFFER_UX, BUFFER_UXD, BUFFER_VISU, BUFFER_OTHER};
...
typedef struct MbsBuffer{
    ...
    /** the array in which the time value corresponding to each value
     * of the array are stored */
    double* t;
    
    /** the array in which the values of the array are stored */
    double* x;
