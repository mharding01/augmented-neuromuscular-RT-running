...
typedef struct Realtime_java
{
    ...
    int nb_q;        ///< number of joints in the .mbs file
    ...
    double **q_save;   ///< tabular saving the joints positions, according to tsim_save
    ...
    double *cur_q;   ///< current joints positions vector
    double *past_q;  ///< requested past joints positions vector
    double *anim_q;  ///< joints position for .anim file
